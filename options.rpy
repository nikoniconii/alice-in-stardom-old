...
init -1 python hide:
    ...
    config.window_title = u"Alice to Stardom"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "Alice to Stardom"
    config.version = "0.1"
    ...
    style.window.background = Frame("textboxxxx.png", 1200, 350)
...
python early:
    config.save_directory = "Alice to Stardom-1458594132"
